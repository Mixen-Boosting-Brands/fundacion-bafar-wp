...
function html5_shortcode_demo_2($atts, $content = null)
{
    ...
    Remove 'galeria' body class
\*------------------------------------*/
function remove_galeria_body_class($classes)
{
    // Remove the 'galeria' class
    if (($key = array_search("galeria", $classes)) !== false) {
        unset($classes[$key]);
    }
    return $classes;
}
...
function bootstrap_pagination(
    ...
    return null;
} // Add .home class only to the body on the homepage
